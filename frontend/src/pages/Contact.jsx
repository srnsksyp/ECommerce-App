    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-500">123 Market Street, Flat 4B <br /> Springfield, IL 62704, United States</p>
          <p className="text-gray-500">Tel: +1 (555) 123-4567 <br /> Email: john.doe@zyra.com</p>
          <p className="font-semibold text-xl text-gray-600">Careers at Zyra</p>
